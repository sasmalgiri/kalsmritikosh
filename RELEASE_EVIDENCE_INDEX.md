...
| S2 | Sensitive evidence never leaks across scope | SensitiveScope ledger + authority hardening DONE (OPS-003A/A.1/A.2 — schema v71, lineage-aware effectiveLabel, brokenLineage denial, userConfirmed authority, 7th Claim branch, File→KO legacy sync, 32 SSA tests); enforcement surfaces (OPS-003B retrieval/prompt + OPS-003C report/receipt/export + OPS-003D screen) PENDING | UNIT |
