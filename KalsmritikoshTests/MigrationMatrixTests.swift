...
struct MigrationMatrixTests {
    ...
    func freshDatabaseReachesLatest() async throws {
        ...
        #expect(SchemaMigrations.latestVersion == 124)          // v121 V2 capture-group provenance · v122 gate-3 reassigned_from · v123 V4 document_class (backfill rode the drain) · v124 S2-U1 chunk salience (backfill rides the shared S2 reindex)
