...
// The PURE wire types (ConformanceSealEnvelope, EvidenceManifestEntry,
// ConformanceSealLinkage, SealedConformance, ConformanceSealError) live in
// ConformanceEnvelope.swift — the SAME file the standalone verifier is
// generated from (scripts/generate-kalverify.sh), so app/CLI parity is
